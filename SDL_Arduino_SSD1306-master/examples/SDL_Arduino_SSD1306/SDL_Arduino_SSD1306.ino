// Modified by SwitchDoc Labs to work with Arduino - based on ESP8266 drivers
/*
 ****** ESP_ssd1306_128x64_I2C demo display *********
 *
 * Demo for using SDL_Arduino_SSD1306 library to communicate
 ...
 *
 * This examples uses the SDL_Arduino_SSD1306 library which is a copy of the default's Adafruit_SSD1306
