...
#### These libraries are used in the workshop and Mayfly tutorials to communicate with sensors and peripherals
...
#### These libraries are used to communicate with other sensors supported by the [EnviroDIY Modular Sensors](https://github.com/EnviroDIY/ModularSensors) library
